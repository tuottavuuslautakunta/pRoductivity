...
save_figs("Kuvio_3_1", height = fig_height)
...
save_figs("Kuvio_3_2", height = fig_height)
...
purrr::imap(figs_3, ~save_figs(.y, plot = .x, , height = fig_height))
...
purrr::imap(figs_5, ~save_figs(.y, plot = .x, , height = fig_height))
# 
