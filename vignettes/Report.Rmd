...
trip_plot(ssca_est_results$lp_ind$model$private_ex26, "lp_ind", base_year, high_country, high_countries)
...
trip_plot(ssca_est_results$lp_ind$model$manu_ex26, "lp_ind", base_year, high_country, high_countries)
