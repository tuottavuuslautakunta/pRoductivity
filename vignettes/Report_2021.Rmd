...
d_class_labs <- 
  c(nd_manu = "Teollisuus - ei digitaalinen",
    d_manu = "Teollisuus - digitaalinen",
...
save_figs("LP_PPP_taso", en = FALSE)
...
save_figs("LP_PPP_taso_suhteessa", en = FALSE)
...
save_figs("LP_PPP_taso_suhteessa_FR", en = FALSE)
...
data_main |> 
  ...
  mutate(geo = recode(geo, !!!set_names(names(countries), countries))) |> 
...
save_figs("Kuvio_2_6", height = fig_height + 4, en = FALSE)
...
# save_figs("level_service_price", en = FALSE)
...
# save_figs("level_service_cp", en = FALSE)
